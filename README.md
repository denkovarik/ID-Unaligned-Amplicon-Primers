...
## Introduction
This project is the Bioinformatics Testing for NuProbe Scientist I for Dennis Kovarik. The software architecture for this project can be seen [here](https://github.com/denkovarik/Kovarik-BI-Testing-for-NuProbe-Scientist-I/tree/main/images).
